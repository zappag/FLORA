...
from surrogate_functions import get_surrogate_details, save_to_netcdf
...
if __name__ == "__main__":
    ...
    for offset in offset_list:
        ...
        save_to_netcdf(pack, path=target, region=region, surrogate_kind=mode, ensemble=ensemble_name)
